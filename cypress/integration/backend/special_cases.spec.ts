  ...
  it("ARR, special chars(tab, CRLF, CR, UTF8)", done => {
    ...
    adapter.request("common/sendArr", data).then(
      (res: any) => {
        ...
        expect(res.table1[0][6]).to.be.equal(data.table1[0].spesh);
        expect(res.table1[0][7]).to.be.equal(data.table1[0].pct);
        expect(res.table1[0][8]).to.be.equal(data.table1[0].speech);
        expect(res.table1[0][9]).to.be.equal(data.table1[0].slash);
        expect(res.table1[0][10]).to.be.equal(data.table1[0].macvar);
        expect(res.table1[0][11]).to.be.equal(data.table1[0].chinese);
        expect(res.table1[0][12]).to.be.equal(data.table1[0].sigma);
        expect(res.table1[0][13]).to.be.equal(data.table1[0].at);
        expect(res.table1[0][14]).to.be.equal(data.table1[0].serbian);
        expect(res.table1[0][15]).to.be.equal(data.table1[0].dollar);
        done();
      },
      err => {
        console.log(err);
